...
export const CALL_ACTIONS = {
  ...
  FETCH_CALL_CENTER_CONFIG_REQUEST: 'FETCH_CALL_CENTER_CONFIG_REQUEST',
...
export const fetchCallCenterConfigRequest = () => ({
  type: CALL_ACTIONS.FETCH_CALL_CENTER_CONFIG_REQUEST,
});
